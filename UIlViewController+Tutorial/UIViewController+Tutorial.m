...
- (void)startCreateNewItemTutorialWithInfo: (NSString *)infoText {
    ...
    [self startTutorialWithInfo:infoText
                        atPoint:CGPointMake(ScreenWidth / 2, ScreenHeight/2 - 80)
   withFingerprintStartingPoint:CGPointMake(ScreenWidth / 2 - 80, ScreenHeight/2)
                    andEndPoint:CGPointMake(ScreenWidth / 2 + 80,ScreenHeight/2)
           shouldHideBackground:NO];
}
...
- (void)startTapTutorialWithInfo: (NSString *)infoText
    ...
    NSString *tutorialKey = [NSString stringWithFormat:@"%@_%@_tutorial", NSStringFromClass ([self class]), NSStringFromSelector(_cmd)];
    ...
    UIView *tutorialView = [[UIView alloc] initWithFrame:CGRectMake(self.view.frame.origin.x, self.view.frame.origin.y, ScreenWidth, ScreenHeight)];
    tutorialView.backgroundColor = [ApplicationMainColor colorWithAlphaComponent:hideBackground ? 1.0 : 0.75];
