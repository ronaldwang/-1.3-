...
@property (weak, nonatomic) IBOutlet UIView *watchSettingView;

@property (weak, nonatomic) IBOutlet UILabel *watchSettingLable;
...
// 反馈
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *feedbackToLanguageVerConstraint;

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *rateUsHorizontal;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *feedbackHorizontal;
...
- (void)setLocalLanguage{
    ...
    self.watchSettingLable.text = LOCALIZATION(@"watchsetting");
...
- (void)setViewContstraints{
    ...
    if (iPhone6plus) {
        ...
        self.themeViewWidthConstraint.constant = 330;
    }else{
         self.themeViewWidthConstraint.constant = 300;
    }
...
// App Watch 设置
- (void)watchSettingAction:(UITapGestureRecognizer*)sender{

    WatchSettingViewController  *watchSetting = [[WatchSettingViewController  alloc ] initWithNibName:@"WatchSettingViewController" bundle:nil];
     [self.navigationController  pushViewController:watchSetting animated:YES];
