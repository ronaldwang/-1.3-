...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.currencyFlag = [[UIImageView alloc ] initWithFrame:CGRectMake(10, 25, 30, 30)];
        [self addSubview:self.currencyFlag];
        
        self.currencyName = [[UILabel alloc ] initWithFrame:CGRectMake(self.currencyFlag.frame.origin.x + self.currencyFlag.frame.size.width + 2, self.currencyFlag.frame.origin.y, 65, 25)];
        ...
        self.baseValue = [[UILabel alloc ] initWithFrame:CGRectMake(self.currencyFlag.frame.origin.x, self.currencyName.frame.origin.y + self.currencyName.frame.size.height + 5, 95, 25)];
        ...
        self.targetCurrencyFlag = [[UIImageView alloc ] initWithFrame:CGRectMake(self.currencyFlag.frame.origin.x, self.baseValue.frame.origin.y + self.baseValue.frame.size.height + 25, 30, 30)];
        [self addSubview:self.targetCurrencyFlag];
        
        self.targetCurrencyName = [[UILabel alloc ] initWithFrame:CGRectMake(self.targetCurrencyFlag.frame.origin.x + self.targetCurrencyFlag.frame.size.width + 2, self.targetCurrencyFlag.frame.origin.y, 65, 25)];
        ...
        self.targetValue = [[UILabel alloc ] initWithFrame:CGRectMake(self.targetCurrencyFlag.frame.origin.x, self.targetCurrencyName.frame.origin.y + self.targetCurrencyName.frame.size.height + 5, 95, 25)];
